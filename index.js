...
App.use(express.static(path.join(require.main.filename,"..",'uploads','images')))
...
App.use(session({secret:"mySecretString",resave:false,saveUninitialized:false,store}))
...
App.use(multer({storage:storageCofig}).single('image'))



// App.use(csrfProtection);
App.use((req,res,next)=>{
    res.locals.csrfToken = "12wfdjhgfdkhgldskfjsldf";
    next();
})
